...
\(10^{5}\) steps. The 1D companion line \citep{ParraPaper02} uses the
same \texttt{Real} trait and the same \texttt{Dual} type, exposed
through the autograd crate. Reproduced by the

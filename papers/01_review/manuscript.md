...
5. Figures: Fig 2 ✅ (`fig02_verification.R` — Stoker + MacDonald +
   Thacker, data from `gen_verification_data` example) and Fig 4 ✅
   (`fig04_huasco_application.R`). Still to draft: Fig 1 (scheme
   schematic), Fig 3 (UK EA T6 depth from `report_depth_snapshot`).

...
5. Figures ✅ ALL FOUR done: Fig 1 (`fig01_scheme.R` — well-balanced
   scheme schematic), Fig 2 (`fig02_verification.R` — Stoker/MacDonald/
   Thacker), Fig 3 (`fig03_uk_ea_t6.R` — UK EA Test 6 depth field),
   Fig 4 (`fig04_huasco_application.R` — Huasco application). Figs 2–4
   data-driven from `gen_verification_data` + solver-2d Huasco outputs;
   Fig 1 is a to-scale schematic.

...
5. Figures: Fig 2 ✅ (verification — Stoker/MacDonald/Thacker), Fig 3
   ✅ (`fig03_uk_ea_t6.R` — UK EA Test 6 depth field), Fig 4 ✅ (Huasco
   application). Figs 2–4 all data-driven from the `gen_verification_data`
   + solver-2d Huasco example outputs. Still to draft: Fig 1 (scheme
   schematic — likely Inkscape/tikz, not data-driven).
